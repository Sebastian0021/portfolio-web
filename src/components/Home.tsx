        ...
        <div className="col-span-2 gap-2 flex flex-col  justify-center sm:col-auto sm:col-start-2 sm:col-end-3 sm:row-start-1">
          <div>
            <div className="flex w-full h-full space-x-2">
              <h1 className="text-4xl font-bold text-[rgb(51,51,51)]">Sebastian Peñaloza</h1>
          ...
          <button className="bg-[#333333] flex items-center justify-center h-14 rounded-2xl w-36 text-white font-semibold mt-6">
            Say Hello
            <svg
              className="ml-1"
              xmlns="http://www.w3.org/2000/svg"
